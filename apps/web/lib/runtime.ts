...
import runtimeBlueprintJson from "../../../templates/runtime/esp-claw-compatible.json";

export const runtimeBlueprint = runtimeBlueprintJson as AiNativeRuntimeBlueprint;

export function getRuntimeModuleLabel(moduleId: string) {
  const labels: Record<string, string> = {
    agent_core: "Agent Core",
    capability_runtime: "Capability Runtime",
    event_router: "Event Router",
    llm_lua_engine: "LLM + Lua Engine",
    local_memory: "Local Memory",
    skills_manager: "Skills Manager",
    mcp_server: "MCP Server",
    mcp_client: "MCP Client",
    im_platform: "IM Platform",
